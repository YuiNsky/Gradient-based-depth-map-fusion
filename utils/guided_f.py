...
def test_gf(low, high):
    low = imageio.imread('14low.jpg').astype(np.float32) / 255
    high = imageio.imread('14high.jpg').astype(np.float32) / 255

    r = 160
    eps = 0.000000001
    dep_smoothed = guided_filter(high, low, r, eps)
